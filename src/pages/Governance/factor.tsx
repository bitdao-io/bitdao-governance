            ...
            <div className='flex flex-col px-96 py-20'>
                ...
                <Card>
                    ...
                    <div className='flex flex-row px-9 py-10'>
                        ...
                        <img src={process.env.REACT_APP_CLOUDFRONT + "bitballogo.png"} />
                    </div>
                    <hr />
                    {!newUser ? (
                        <div>
                        ...
                        <div className='font-mono flex flex-col px-7 py-4'>
                            ...
                            <button className='px-36 mx-auto bg-red rounded-xl py-5 my-3 shadow-2xl' onClick={connected ? handleOpen : handleWallet}>
